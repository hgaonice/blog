...
public class LogViewAspect {
    ...
    @Pointcut("@annotation(com.gaoh.modules.common.annotation.LogView)")
    ...
    private void saveViewLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        com.gaoh.modules.common.annotation. LogView viewLog = method.getAnnotation(com.gaoh.modules.common.annotation.LogView.class);
        //注解上的类型
