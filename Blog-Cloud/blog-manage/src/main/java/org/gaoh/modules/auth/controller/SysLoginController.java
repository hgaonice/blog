...
import org.gaoh.modules.sys.mapper.SysUserMapper;
...
public class SysLoginController extends AbstractController {
    ...
    public org.gaoh.common.vo.Result test() {
        return org.gaoh.common.vo.Result.ok(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " - test");
    }

    @GetMapping("/test/test1/{val}")
    public Result test1(@PathVariable("val") Integer val) {
        return new Result().put("key", val);
    }
