package org.gaoh.common.mq.aspect;

import org.gaoh.common.constants.RabbitMqConstants;
import org.gaoh.common.mq.annotation.RefreshEsMqSender;
import org.gaoh.common.util.RabbitMqUtils;
...
public class RefreshEsMqAspect {
    ...
    @Pointcut("@annotation(org.gaoh.common.mq.annotation.RefreshEsMqSender)")
